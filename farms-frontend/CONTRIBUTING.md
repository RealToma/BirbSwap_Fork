# Contributing to the BirbSwap ecosystem 🥞

Thanks for taking the time to contribute !
You can start by reading our Contribution guidelines
...
```
TranslateString(675, `You have ${fastBalance} left in your wallet`, { num: fastBalance })
```
